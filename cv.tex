...
\address{ Cambridge, MA, USA \\ \url{trevor.ablett@gmail.com} \\ \url{trevorablett.github.io}} % Your address
...
\nocitepapers{
    2024_Ablett_vpace,
    2024_Ablett_Push,
    ablettFastReinforcementLearning2024,    
...
\nocitepatents{
    samsung_tactile_patent,
    samsung_manipulators_patent,
    calibration_patent,
    callisto_patent}
...
\begin{rSubsection}{Boston Dynamics}{July 2025 - Present}{Staff Research Scientist}{Waltham MA, USA}
	\item Researching and implementing features for training manipulation policies for the Atlas humanoid robot.
    \item Using a combination of imitation learning, reinforcement learning, simulation, and sim-to-real approaches.
\end{rSubsection}

\begin{rSubsection}{University of Toronto}{Sept. 2017 - June 2025}{Graduate Researcher (Ph.D)}{Toronto ON, Canada}
	\item Published numerous papers in top tier robotics and machine learning venues related to addressing distribution shift in robotic learning.
    \item Researched methods for applying imitation learning and inverse reinforcement learning to robotic manipulation.
    \item Mentored multiple undergraduate and graduate level students each year.
\end{rSubsection}
...
\begin{rSubsection}{Samsung Research America}{September 2022 - November 2023}{Research Intern -- Applied Reinforcement Learning}{Montreal, QC, Canada}
	\item Lead research for publication in robotic learning with tactile sensing, collaborated on many other papers.
...
\textbf{Ph.D}, University of Toronto, \textit{Toronto, Ontario, Canada} \hfill {2017 - 2025} \\
...
\textbf{M.A.Sc.} (Transferred to PhD), University of Toronto, \textit{Toronto, Ontario, Canada} \hfill {2016 - 2017} \\
Institute for Aerospace Studies, Space and Terrestrial Autonomous Robotics Systems Lab \smallskip \\
\textit{Topic:} Active Calibration of a Mobile Manipulator \\
\textit{Supervisor:} Dr. Jonathan Kelly. \smallskip \\
Overall GPA: 4.0/4.0

\textbf{B.Eng., Mechatronics}, McMaster University, \textit{Hamilton, Ontario, Canada} \hfill {2011 - 2015} \\
Faculty of Engineering, Dept. of Computing and Science \smallskip \\
Summa cum laude, Overall GPA: 3.9/4.0

\textbf{B.A., Psychology}, McMaster University, \textit{Hamilton, Ontario, Canada} \hfill {2009 - 2015} \\
